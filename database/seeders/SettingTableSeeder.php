...
class SettingTableSeeder extends Seeder
{
    ...
    {
        Customer::Create([
            'name' => 'حسين طاهر الحجي',
            'email' => 'customer@infypos.com',
            'phone' => '712082116',
            'country' => 'Saudi Arabia',
            'city' => 'صنعاء',
            'address' => 'صنعاء شارع الستين حى السنينه',
        ]);
        Warehouse::create([
            'name' => 'warehouse',
            'phone' => '123456789',
        ...
        if (! keyExist('email')) {
            Setting::create(['key' => 'email', 'value' => '23164083@su.ede.ye']);
        }

        if (! keyExist('company_name')) {
            Setting::create(['key' => 'company_name', 'value' => 'AbubakerCo']);
        }
        ...
        if (! keyExist('address')) {
            Setting::create([
                'key' => 'address', 'value' => 'صنعاء شارع الستين حى السنينه',
            ]);
        }
